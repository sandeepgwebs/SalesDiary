      ...
      child: ListView(
        children: <Widget>[
          ...
          ListTile(
            ...
            title: Text('Rice',style: Theme.of(context).textTheme.body1),
            subtitle: Row(
              children: <Widget>[
                Text('8kg at',style: Theme.of(context).textTheme.subtitle),
                Padding(
                  padding: EdgeInsets.only(top: 5),
                  child: Icon(MyFlutterApp.rupee,size: 14,color:Color(0xFF969799)),
                ),
                Text(':10.00 each',style: Theme.of(context).textTheme.subtitle),
              ],
            ),
            trailing: Column(
              crossAxisAlignment: CrossAxisAlignment.center,
              mainAxisAlignment: MainAxisAlignment.center,
              children: <Widget>[
                Icon(MyFlutterApp.rupee,size: 18,color: Colors.black),
                Text('80',style: Theme.of(context).textTheme.body1),
              ],
            ),
          ),
          Divider(),
          ListTile(
            ...
            title: Text('Ground Nut Oil',style: Theme.of(context).textTheme.body1),
            subtitle: Row(
              children: <Widget>[
                Text('7kg at',style: Theme.of(context).textTheme.subtitle),
                Padding(
                  padding: EdgeInsets.only(top: 5),
                  child: Icon(MyFlutterApp.rupee,size: 14,color:Color(0xFF969799)),
                ),
                Text(':100.00 each',style: Theme.of(context).textTheme.subtitle),
              ],
            ),
            trailing: Column(
              crossAxisAlignment: CrossAxisAlignment.center,
              ...
              children: <Widget>[
                Icon(MyFlutterApp.rupee,size: 18,color: Colors.black),
                Text('700',style: Theme.of(context).textTheme.body1),
              ],
            ),
          ),
          Divider(),
          ListTile(
            ...
            title: Text('Broccoli',style: Theme.of(context).textTheme.body1),
            subtitle: Row(
              children: <Widget>[
                Text('9kg at',style: Theme.of(context).textTheme.subtitle),
                Padding(
                  padding: EdgeInsets.only(top: 5),
                  child: Icon(MyFlutterApp.rupee,size: 14,color:Color(0xFF969799)),
                ),
            ...
            trailing: Column(
              ...
              children: <Widget>[
                Icon(MyFlutterApp.rupee,size: 18,color: Colors.black),
                Text('900',style: Theme.of(context).textTheme.body1),
              ],
            ),
          ),
          Divider(),
          ListTile(
            ...
            title: Text('Soyabean Oil',style: Theme.of(context).textTheme.body1),
            subtitle: Row(
              children: <Widget>[
                Text('10kg at',style: Theme.of(context).textTheme.subtitle),
                Padding(
                  padding: EdgeInsets.only(top: 5),
                  child: Icon(MyFlutterApp.rupee,size: 14,color:Color(0xFF969799)),
                ),
                Text(':1000.00 each',style: Theme.of(context).textTheme.subtitle),
              ],
            ),
            trailing: Column(
              crossAxisAlignment: CrossAxisAlignment.center,
          ...
          return AlertDialog(
            ...
            title: Column(
              children: <Widget>[
                ...
                Text('Are You Sure Delete Transaction',style: TextStyle(color: Color(0xFF0099ff),fontWeight: FontWeight.w500,fontSize: 16,fontFamily: 'Lato',
                  shadows: <Shadow>[
                    Shadow(
