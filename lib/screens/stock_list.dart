    ...
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(
          ...
          title: Text('Stock',style: Theme.of(context).textTheme.headline,),
          leading: InkWell(
                ...
                children: [
                  TableRow( children: [
                    ...
                    Container(
                      ...
                      padding: EdgeInsets.only(top: 15,bottom: 15),
                      child: Center(
                        child: Text("Purchase",style: Theme.of(context).textTheme.body1),
                      ),
                    ),
                    Container(
                      color: Color(0xFFF0EdE5),
                      padding: EdgeInsets.only(top: 15,bottom: 15),
                      child: Center(
                        child:Text("Sold",style: Theme.of(context).textTheme.body1),
                      ),
                    ),
                    Container(
                      color: Color(0xFFe8e8e8),
                      padding: EdgeInsets.only(top: 15,bottom: 15),
                      child: Center(
                        child:Text("Left",style: Theme.of(context).textTheme.body1),
                      ),
                    ),
                    Container(
                      color: Color(0xFFF0EdE5),
                      padding: EdgeInsets.only(top: 15,bottom: 15),
                      child: Center(
                        child:Text("Sale",style: Theme.of(context).textTheme.body1),
                      ),
                    ),
                  ]),
                ],
              ...
              TableRow( children: [
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Text("20 kg",style: Theme.of(context).textTheme.subhead),
                    ],
                  ),
                ),
                Container(
                  ...
                  child: Row(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: <Widget>[
                      Text("10 kg",style: Theme.of(context).textTheme.subhead),
                    ],
                  ),
                ),
                Container(
                ...
                Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text("700",style: Theme.of(context).textTheme.subhead),
                    ],
                  ),
                ),
              ]),
